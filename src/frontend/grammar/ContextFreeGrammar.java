...
public class ContextFreeGrammar {
        ...
        for (Rule rule : this.rules) {
            try {
                ...
                throw new RuntimeException(
                    "NullPtrException on adding rule to startsWith:\n\t" + rule,
                    e
                );
            }
        }
    ...
    public List<Rule> getRules(Symbol sym) {
        return startsWith.get(sym);
    }

    public ComparableSet<Symbol> getAllSymbols() {
        return allSymbols;
    }

    public ComparableSet<Symbol> getNonTerminals() {
        return nonTerminals;
    }

    public ComparableSet<Symbol> getTerminals() {
        return terminals;
    }
    ...
    public boolean isNonTerminal(Symbol sym) {
